...
class WebFetcher {
    ...
    fetch(uri, onDocument) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield fetch(uri, Object.assign(Object.assign({}, this._config.requestConfig), { method: 'GET', headers }));
        ...
        replacement: function (content, node) {
            ...
            if (isHeadingRow(node)) {
                ...
                for (let i = 0; i < children.length; i++) {
                    let border = "---";
                    const align = (((_b = (_a = children[i]).getAttribute) === null || _b === void 0 ? void 0 : _b.call(_a, "align")) || "").toLowerCase();
                    if (align)
...
function isHeadingRow(tr) {
    ...
    return (parentNode.nodeName === "THEAD" ||
        (parentNode.firstChild === tr &&
            ...
            every.call(parentNode ? tr.childNodes : [], function (n) {
